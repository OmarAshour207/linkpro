    ...
    <div class="mdk-drawer-layout__content page">
        <div class="container-fluid page__heading-container">
            <div class="page__heading d-flex align-items-center">
                ...
                <a href="{{ route('supplies.create') }}" class="btn btn-success ml-3">{{ __('Create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
        ...
        <div class="container-fluid page__container">
                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width: 10%">
                                <a href="{{ route('supplies.edit', $supply->id) }}" class="btn btn-sm btn-link">
            ...
            <div class="mt-4">
                {{ $supplies->links('dashboard.pagination.custom') }}
            </div>
        </div>
