    ...
    <div class="mdk-drawer-layout__content page">
        <div class="container-fluid page__heading-container">
            <div class="page__heading d-flex align-items-center">
                ...
                <a href="{{ route('paths.create') }}" class="btn btn-success ml-3">{{ __('Create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
        ...
        <div class="container-fluid page__container">
                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('paths.edit', $path->id) }}" class="btn btn-sm btn-link">
                                    <i class="fa fa-edit fa-2x"></i>
                                </a>
                                <form action="{{ route('paths.destroy', $path->id) }}" method="post" style="display: inline-block">
                                    @csrf
                                    @method('delete')
            ...
            <div class="mt-4">
                {{ $paths->links('dashboard.pagination.custom') }}
            </div>
        </div>
