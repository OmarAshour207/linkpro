        ...
        <div class="navbar navbar-expand-sm navbar-main navbar-light  pr-0" id="navbar" data-primary>
            <div class="container-fluid p-0">
                ...
                <a href="{{ route('dashboard.index') }}" class="navbar-brand ">
                    ...
                    <img src="{{ asset('dashboard/images/logos/logo.jpg') }}" style="width: 20px;"/>
...
{{--                    </svg>--}}
                ...
                <form class="search-form d-none d-sm-flex flex">
                    ...
                    <input type="text" class="form-control" placeholder=" {{ __('Search here') }} " value="{{ request()->search }}" name="search">
                </form>
                ...
                <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                    <li class="nav-item dropdown">
                        ...
                        <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('edit.profile') }}"><i class="fa fa-edit"></i> {{ __('Edit Profile') }} </a>
                        </div>
                    </li>
                </ul>
